...
class DeviceFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'brand_id' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'stock_date' => '2019-03-13 09:30:28',
                'warranty_period' => '2019-03-13 09:30:28',
                'created_time' => '2019-03-13 09:30:28',
                'update_time' => '2019-03-13 09:30:28',
                'is_deleted' => 1
            ],
        ];
        parent::init();
