...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'relate_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'relate_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'path' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'relate_id' => 1,
                'relate_name' => 'Lorem ipsum dolor sit amet',
                ...
                'created_time' => '2019-03-20 04:04:14',
                'update_time' => '2019-03-20 04:04:14',
                'is_deleted' => 1
            ],
        ];
        parent::init();
